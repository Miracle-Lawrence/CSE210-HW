...
class Program
{
    static void Main(string[] args)
    {
        ...
        video1._title = "How to make sausage rolls";
        video1._author = "David Sung";
        video1._length = 600; // 10 minutes

        Video video2 = new Video();
        video2._title = "Easy ways to bake a cake";
        video2._author = "Travis Collins";
        video2._length = 900; // 15 minutes

        Video video3 = new Video();
        video3._title = "How to make pizza from scratch";
        video3._author = "Daniel Tyson";
